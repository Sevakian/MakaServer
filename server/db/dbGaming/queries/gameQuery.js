...
dbConnection.addGame = (value) => {
  ...
  return new Promise((resolve, reject) => {
    dbConnection.query(
      `INSERT INTO spiele (spielename, spieleserie, genre, erscheinungsjahr, entwickler, dimension, bild, status, größegb, anzahlverkauft, text) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        name,
        serie,
        genre,
